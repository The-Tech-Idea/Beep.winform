...
{
    [AddinAttribute(Caption = "Connection Types", Name = "uc_connectionTypes", misc = "App", ObjectType = "Beep", addinType = AddinType.Control, displayType = DisplayType.InControl)]
    public partial class uc_connectionTypes : UserControl,IDM_Addin
    {
        public uc_connectionTypes()
        {
            InitializeComponent();
        }
