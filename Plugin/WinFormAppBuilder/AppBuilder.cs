    ...
    public class AppBuilder : IAppBuilder
    {
        ...
        public bool BuildApp(IDMEEditor dMEEditor, PassedArgs passedArgs)
        {
...

            {
                ...
                Visutil =(IVisManager) passedArgs.Objects.Where(c => c.Name == "VISUTIL").FirstOrDefault().obj;
                if (Winform)
                {
                    Visutil.ShowPage("uc_WinformApp", (PassedArgs)DMEEditor.Passedarguments,DisplayType.Popup);
                }
