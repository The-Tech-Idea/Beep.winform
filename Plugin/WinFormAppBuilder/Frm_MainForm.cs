...
namespace TheTechIdea.Beep.AppBuilder
{
    public partial class Frm_MainForm : Form, IDM_Addin, IAppComponent
    {
        ...
        string IAppComponent.ComponentType { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        public bool IsTableView { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
       ...
       // App app;
        ...
        private void DataTreeView_NodeMouseDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
          ...
          //  entds.Dataconnection.OpenConnection();
            ...
            {
                Visutil.Controlmanager.MsgBox("Error", $"Failed to Open Entity DataSource {EntityStructure.DataSourceID}");
            }
        }
        ...
        private void ShowCRUD()
        {
            if (EntityStructure != null)
            {
                ...
                Visutil.ShowPage("uc_getentities",  Passedarguments,DisplayType.Popup);
            }
