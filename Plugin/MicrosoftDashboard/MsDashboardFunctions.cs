...
{
    [AddinAttribute(Caption = "Microsoft Library", Name = "MsDashboardFunctions", misc = "MsDashboardFunctions", addinType = AddinType.Class, iconimage = "chart.ico",order =4)]
    public class MsDashboardFunctions : IFunctionExtension
    {
        ...
        IBranch pbr;
        IBranch RootBranch;
        public MsDashboardFunctions(IDMEEditor pdMEEditor, VisManager pvisManager, TreeControl ptreeControl)
        {
        ...
        [CommandAttribute(Caption = "Dashboard", Name = "MsDashboard", Click = true, iconimage = "chart.ico", PointType = EnumPointType.DataPoint)]
            ...
            if (pbr.BranchType == EnumPointType.DataPoint)
            {
                try
                {
                   ...
                   Passedarguments.DatasourceName = pbr.BranchText;
                    Vismanager.ShowPage("MsDashboardDesigner", (PassedArgs)Passedarguments, DisplayType.InControl);
