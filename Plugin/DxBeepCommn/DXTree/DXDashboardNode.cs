...
{
    public class DXDashboardNode : IBranch
    {
        public DXDashboardNode()
        {

        }
        public DXDashboardNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename, string ConnectionName)
        {
        ...
        public string BranchText { get; set; } = "Dashboard Designer";
        ...
        public string IconImageName { get; set; } = "chart.ico";
        ...
        [CommandAttribute(Caption = "Show", Hidden = false, iconimage = "chart.ico")]
        public IErrorsInfo Show()
        {
            ...
            try
            {
                ...
                Visutil.ShowPage("uc_DxDashBoardDesigner", Passedarguments, DisplayType.Popup);
