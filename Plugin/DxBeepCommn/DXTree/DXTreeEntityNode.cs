...
{
    public  class DXTreeEntityNode : IBranch
    {
        public DXTreeEntityNode()
        {

        }
        public DXTreeEntityNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename, string ConnectionName)
        {
        ...
        public IErrorsInfo Show()
        {
            ...
            try
            {
                ...
                {
                    Visutil.ShowPage(AddinTreeStructure.className, Passedarguments, DisplayType.Popup);
                }
                else
                {
