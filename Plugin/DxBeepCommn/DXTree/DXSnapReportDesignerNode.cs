...
{
    [ClassProperties(FileType = "REPORTING",iconimage = "snapdesigner.ico")]
    public class DXSnapReportDesignerNode: IBranch
    {
        public DXSnapReportDesignerNode()
    {

    }
    public DXSnapReportDesignerNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename, string ConnectionName)
    {
    ...
    public IErrorsInfo Edit()
    {
        ...
        try
        {
            ...
            {  // Obj= obj,
                ...
                Visutil.ShowPage("Frm_DxSnapDesigner", Passedarguments,DisplayType.InControl);
        ...
        [CommandAttribute(Caption = "Preview", Hidden = false)]
        public IErrorsInfo Preview()
        {
            ...
            try
            {
                ...
                Visutil.ShowPage("uc_snapreportviewer",  Passedarguments, DisplayType.Popup);
    ...
    public IErrorsInfo DoubleClick()
    {
        ...
        try
        {
                ...
                Visutil.ShowPage("Frm_DxSnapDesigner", Passedarguments);
