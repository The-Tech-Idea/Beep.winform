...
namespace AI
{
    ...
    public class ACCORDNode : IBranch
    {
        ...
        public ACCORDNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename, string ConnectionName)
        {
        ...
        public string BranchText { get; set; } = "Accord";
        ...
        public string IconImageName { get; set; } = "accord.ico";
        public string BranchStatus { get; set; }
        public int ParentBranchID { get; set; }
        public string BranchDescription { get; set; }
        public string BranchClass { get; set; } = "AI.Accord";
