...
namespace AI
{
    ...
    public class AICPythonNode : IBranch
    {
        ...
        public string IconImageName { get; set; } = "python.ico";
        ...
        public IErrorsInfo ScriptEditor()
        {
            ...
            try
            {
                ...
                //Visutil.ShowUserControlInContainer("uc_cpythonscriptrunner", Visutil.DisplayPanel, DMEEditor, args, Passedarguments);
                Visutil.ShowPage("uc_cpythonscriptrunner",  Passedarguments, DisplayType.InControl);
