...
{
    [AddinAttribute(Caption = "Grid", Name = "BeepGrid", misc = "BeepGrid", addinType = AddinType.Class, iconimage = "GridApplication.png")]
    public class BeepGrid : IAppComponent, IBeepControlInterface
    {
       
        public BeepGrid()
        {
            ID = new Guid().ToString();
            ComponentType = (new DataGridView()).GetType().AssemblyQualifiedName;
            IsContainer = false;
            IsTableView = true;
        ...
        {
            gridView = (DataGridView)Panelcontrol.BeepControl;
