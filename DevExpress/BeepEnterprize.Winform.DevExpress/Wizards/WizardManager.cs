...
namespace BeepEnterprize.Winform.Vis.Wizards
{
    ...
    {
        public event EventHandler<IWizardManager> WizardCloseEvent;
        public event EventHandler<IWizardManager> WizardNextNodeEvent;
        public event EventHandler<IWizardManager> WizardPreviousNodeEvent;
        ...
        private void Close()
        {
            WizardCloseEvent?.Invoke(this, this);
