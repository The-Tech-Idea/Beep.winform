...
namespace Beep.ViewModels
{
    ...
    {
        public static IErrorsInfo CreateEntityMap(IDMEEditor DMEEditor,string SourceEntityName, string SourceDataSourceName, string DestEntityName, string DestDataSourceName)
        {
            try
            {
        ...
        public static IErrorsInfo CreateEntityMap(IDMEEditor DMEEditor,string DestEntityName, string DestDataSourceName)
        {
            try
            {
                DMEEditor.ErrorObject.Flag = Errors.Ok;
