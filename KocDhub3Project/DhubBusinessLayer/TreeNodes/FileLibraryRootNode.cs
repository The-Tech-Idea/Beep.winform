...
namespace KOC.DHUB3.TreeNodes
{
    ...
    {
        public FileLibraryRootNode(int iD, IDMEEditor dMEEditor, IDataSource dataSource, string dataSourceName, ITree treeEditor, IVisManager visutil,  int miscID, string name, int branchID, string iconImageName)
        {
            ID = iD;
            DMEEditor = dMEEditor;
