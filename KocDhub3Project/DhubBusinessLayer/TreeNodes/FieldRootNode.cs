...
namespace KOC.DHUB3.TreeNodes
{
    public class FieldRootNode : IBranch
    {
        ...
        public string BranchText { get; set; } = "Fields";
        ...
        public string BranchDescription { get; set; } = "Root node for Fields Library";
        public string BranchClass { get; set; } = "Dhub3.Field";
