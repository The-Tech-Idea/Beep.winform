...
{
    public class BusinessProcessPendingNode : IBranch
    {
        public BusinessProcessPendingNode(int iD, int parentBranchID, IDMEEditor dMEEditor, IDataSource dataSource, string dataSourceName, ITree treeEditor, IVisManager visutil, int miscID, string name, int branchID, string iconImageName)
        {
            ID = iD;
            DMEEditor = dMEEditor;
