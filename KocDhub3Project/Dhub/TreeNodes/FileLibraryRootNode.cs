...
{
    public class FileLibraryRootNode : IBranch
    {
        public FileLibraryRootNode(int iD, IDMEEditor dMEEditor, IDataSource dataSource, string dataSourceName, ITree treeEditor, IVisManager visutil, EntityStructure entityStructure, int miscID, string name, int branchID, string iconImageName)
        {
            ID = iD;
            DMEEditor = dMEEditor;
