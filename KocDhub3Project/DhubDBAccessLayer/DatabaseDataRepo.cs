...
{
    public class DatabaseDataRepo : IDataRepo
    {
        ...
        public DatabaseDataRepo(IDMEEditor dMEditor, string dataSourcename)
        {
            DMEditor = dMEditor;
        ...
        public DatabaseDataRepo(IDMEEditor dMEditor, string pStart_date, string pEnd_date)
        {
        ...
        private RDBSource RDB;
        private RDBDataConnection RDBConn;
        private IDbConnection? KocDB;
        #endregion
        #region "Well Data"
        ...
        public WELL_LATEST_DATA GetWell(int pwell_completion_id)
        {
            WELL_LATEST_DATA Well = new WELL_LATEST_DATA();
            try
            {
        ...
        public IEnumerable<WELL_OPERATION_STATUS_VW> GetOperations(string puwi)
        {
            IEnumerable<WELL_OPERATION_STATUS_VW> ops;
            try
            {
                DMEditor.ErrorObject.Ex = null;
                DMEditor.ErrorObject.Flag = Errors.Ok;
                ...
                var parameters = new { UWI = puwi };
                var src = Task.Run(() => { return LoadData<WELL_OPERATION_STATUS_VW>("select * from WELL_OPERATION_STATUS_VW where UBHI=:uwi or uwi=:uwi", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<WELL_OPERATION_STATUS_VW> GetOperations(int pwell_completion_id)
        {
            IEnumerable<WELL_OPERATION_STATUS_VW> ops;
            try
            {
                ...
                var parameters = new { well_completion_id = pwell_completion_id };
                var src = Task.Run(() => { return LoadData<WELL_OPERATION_STATUS_VW>("select * from WELL_OPERATION_STATUS_VW where well_completion_s=:well_completion_id", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<FBHP_VW> GetFBHP(string puwi)
        {
            IEnumerable<FBHP_VW> ops;
            try
            {
                DMEditor.ErrorObject.Ex = null;
                DMEditor.ErrorObject.Flag = Errors.Ok;
                ...
                var parameters = new { UWI = puwi };
                var src = Task.Run(() => { return LoadData<FBHP_VW>("select * from FBHP_VW where uwi=:uwi or uwi=:uwi", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<FBHP_VW> GetFBP(int pwell_completion_id)
        {
            IEnumerable<FBHP_VW> ops;
            try
            {
                ...
                var parameters = new { well_completion_id = pwell_completion_id };
                var src = Task.Run(() => { return LoadData<FBHP_VW>("select * from FBHP_VW where well_completion_s=:well_completion_id", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<SBHP_VW> GetSBHP(string puwi)
        {
            IEnumerable<SBHP_VW> ops;
            try
            {
                DMEditor.ErrorObject.Ex = null;
                DMEditor.ErrorObject.Flag = Errors.Ok;
                ...
                var parameters = new { UWI = puwi };
                var src = Task.Run(() => { return LoadData<SBHP_VW>("select * from SBHP_VW where uwi=:uwi or uwi=:uwi", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<SBHP_VW> GetSBP(int pwell_completion_id)
        {
            IEnumerable<SBHP_VW> ops;
            try
            {
                ...
                var parameters = new { well_completion_id = pwell_completion_id };
                var src = Task.Run(() => { return LoadData<SBHP_VW>("select * from SBHP_VW where well_completion_s=:well_completion_id", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<PORTABLE_TEST_VW> GetPortable(string puwi)
        {
            IEnumerable<PORTABLE_TEST_VW> ops;
            try
            {
                DMEditor.ErrorObject.Ex = null;
                DMEditor.ErrorObject.Flag = Errors.Ok;
                ...
                var parameters = new { UWI = puwi };
                var src = Task.Run(() => { return LoadData<PORTABLE_TEST_VW>("select * from PORTABLE_TEST_VW where uwi=:uwi or uwi=:uwi", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<PORTABLE_TEST_VW> GetPortable(int pwell_completion_id)
        {
            IEnumerable<PORTABLE_TEST_VW> ops;
            try
            {
                ...
                var parameters = new { well_completion_id = pwell_completion_id };
                var src = Task.Run(() => { return LoadData<PORTABLE_TEST_VW>("select * from PORTABLE_TEST_VW where well_completion_id=:well_completion_id", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<PERFORATION_VW> GetPerforation(string puwi)
        {
            IEnumerable<PERFORATION_VW> ops;
            try
            {
                DMEditor.ErrorObject.Ex = null;
                DMEditor.ErrorObject.Flag = Errors.Ok;
                ...
                var parameters = new { UWI = puwi };
                var src = Task.Run(() => { return LoadData<PERFORATION_VW>("select * from PERFORATION_VW where uwi=:uwi or uwi=:uwi", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<PERFORATION_VW> GetPerforation(int pwell_completion_id)
        {
            IEnumerable<PERFORATION_VW> ops;
            try
            {
                ...
                var parameters = new { well_completion_id = pwell_completion_id };
                var src = Task.Run(() => { return LoadData<PERFORATION_VW>("select * from PERFORATION_VW where well_completion_s=:well_completion_id", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<ESP_OPERATION_STATUS_VW> GetEspOperation(string puwi)
        {
            IEnumerable<ESP_OPERATION_STATUS_VW> ops;
            try
            {
                DMEditor.ErrorObject.Ex = null;
                DMEditor.ErrorObject.Flag = Errors.Ok;
                ...
                var parameters = new { UWI = puwi };
                var src = Task.Run(() => { return LoadData<ESP_OPERATION_STATUS_VW>("select * from ESP_OPERATION_STATUS_VW where uwi=:uwi or uwi=:uwi", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<ESP_OPERATION_STATUS_VW> GetEspOperation(int pwell_completion_id)
        {
            IEnumerable<ESP_OPERATION_STATUS_VW> ops;
            try
            {
                ...
                var parameters = new { well_completion_id = pwell_completion_id };
                var src = Task.Run(() => { return LoadData<ESP_OPERATION_STATUS_VW>("select * from ESP_OPERATION_STATUS_VW where well_completion_s=:well_completion_id", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<DOWNHOLE_FACILITY_VW> GetDownHoleFacility(string puwi)
        {
            IEnumerable<DOWNHOLE_FACILITY_VW> ops;
            try
            {
                DMEditor.ErrorObject.Ex = null;
                DMEditor.ErrorObject.Flag = Errors.Ok;
                ...
                var parameters = new { UWI = puwi };
                var src = Task.Run(() => { return LoadData<DOWNHOLE_FACILITY_VW>("select * from DOWNHOLE_FACILITY_VW where uwi=:uwi or uwi=:uwi", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<DEVIATION_SURVEY_VW> GetDeviationSurvey(string puwi)
        {
            IEnumerable<DEVIATION_SURVEY_VW> ops;
            try
            {
                DMEditor.ErrorObject.Ex = null;
                DMEditor.ErrorObject.Flag = Errors.Ok;
                ...
                var parameters = new { UWI = puwi };
                var src = Task.Run(() => { return LoadData<DEVIATION_SURVEY_VW>("select * from DEVIATION_SURVEY_VW where uwi=:uwi or uwi=:uwi", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<WORKOVER_VW> GetWorkover(string puwi)
        {
            IEnumerable<WORKOVER_VW> ops;
            try
            {
                DMEditor.ErrorObject.Ex = null;
                DMEditor.ErrorObject.Flag = Errors.Ok;
                ...
                var parameters = new { UWI = puwi };
                var src = Task.Run(() => { return LoadData<WORKOVER_VW>("select * from WORKOVER_VW where uwi=:uwi or uwi=:uwi", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<WIRELINE_ACTIVITY_VW> GetWireline(string puwi)
        {
            IEnumerable<WIRELINE_ACTIVITY_VW> ops;
            try
            {
                DMEditor.ErrorObject.Ex = null;
                DMEditor.ErrorObject.Flag = Errors.Ok;
                ...
                var parameters = new { UWI = puwi };
                var src = Task.Run(() => { return LoadData<WIRELINE_ACTIVITY_VW>("select * from WIRELINE_ACTIVITY_VW where uwi=:uwi or uwi=:uwi", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<WIRELINE_ACTIVITY_VW> GetWireline(int pwell_completion_id)
        {
            IEnumerable<WIRELINE_ACTIVITY_VW> ops;
            try
            {
                ...
                var parameters = new { well_completion_id = pwell_completion_id };
                var src = Task.Run(() => { return LoadData<WIRELINE_ACTIVITY_VW>("select * from WIRELINE_ACTIVITY_VW where well_completion_s=:well_completion_id", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<WELL_TEST_VW> GetTests(string puwi)
        {
            IEnumerable<WELL_TEST_VW> ops;
            try
            {
                DMEditor.ErrorObject.Ex = null;
                DMEditor.ErrorObject.Flag = Errors.Ok;
                ...
                var parameters = new { UWI = puwi };
                var src = Task.Run(() => { return LoadData<WELL_TEST_VW>("select * from WELL_TEST_VW where uwi=:uwi or uwi=:uwi", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<WELL_TEST_VW> GetTests(int pwell_completion_id)
        {
            IEnumerable<WELL_TEST_VW> ops;
            try
            {
                ...
                var parameters = new { well_completion_id = pwell_completion_id };
                var src = Task.Run(() => { return LoadData<WELL_TEST_VW>("select * from WELL_TEST_VW where well_completion_s=:well_completion_id", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        //PORTABLE_TEST_VW
        //PERFORATION_VW
        //ESP_OPERATION_STATUS_VW
        //DEVIATION_SURVEY_VW
        //WORKOVER_VW
        //WIRELINE_ACTIVITY_VW
        #endregion
        #region "Field Data"
        public List<WELL_LATEST_DATA> GetFieldWells(string pfldid)
        {
        ...
        public List<WELL_LATEST_DATA> GetFacilityWells(string pFacilityId)
        {
            List<WELL_LATEST_DATA> Wells = new List<WELL_LATEST_DATA>();
            try
            {
                ...
                var src = Task.Run(() => { return LoadData<WELL_LATEST_DATA>("select * from well_latest_data where current_gc=:FacilityId", parameters); });
                src.Wait();
                Wells = (List<WELL_LATEST_DATA>)src.Result;
            }
            catch (Exception ex)
        ...
        public double ScalarOutDiaTubing(string puwi)
        {
            ...
            try
            {
                double r = 0;
                var parameters = new { uwi = puwi };
                var retval = Convert.ToDouble(KocDB.QueryAsync<string>(@"SELECT  MIN(OUTER_DIAMETER) AS OUTER_DIAMETER FROM   DOWNHOLE_FACILITY_CAT_VW  WHERE   (UWI = @puwi) AND (ACTIVE = \'Y\') AND (END_TIME IS NULL) AND (FACILITY_NAME = \'TUBING\') ORDER BY BOTTOM DESC", parameters).Result.FirstOrDefault());
                if (retval != null)
                {
...
WHERE        (tt.PREFERRED_FLAG = 'Y') AND (tt.UWI = @puwi)", parameters).Result;
        ...
        #region "Other Data"
        //LOV
        public IEnumerable<LOV> GetLov(string plov_type)
        {
            IEnumerable<LOV> ops;
            try
            {
                ...
                var parameters = new { lov_type = plov_type };
                var src = Task.Run(() => { return LoadData<LOV>("select * from LOV where lov_type=:lov_type ", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
        ...
        public IEnumerable<LOV> GetLov(string plov_type,string plov_code)
        {
            IEnumerable<LOV> ops;
            try
            {
                ...
                var parameters = new { lov_type = plov_type,lov_code= plov_code };
                var src = Task.Run(() => { return LoadData<LOV>("select * from LOV where lov_type=:lov_type and lov_code=:lov_code ", parameters); });
                src.Wait();
                ops = src.Result;
            }
            catch (Exception ex)
